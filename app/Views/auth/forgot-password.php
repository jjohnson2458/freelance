...
<head>
    ...
    <title>Forgot Password - Freelance Proposal Optimizer</title>
    ...
    <div class="px-3 w-100" style="max-width: 420px;">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <p class="text-muted small text-center mb-3">Enter your email address and we'll send you a link to reset your password.</p>
