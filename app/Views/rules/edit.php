...
<main class="main-content flex-grow-1 p-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h1 class="h3 mb-0">Edit Proposal Rule</h1>
    </div>
        ...
        <div class="card-body">
            <form method="POST" action="/rules/<?= $rule['id'] ?>/update">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="category" name="category" required>
                        ...
                        <?php foreach ($categories as $cat): ?>
                            <option value="<?= $cat ?>" <?= $rule['category'] === $cat ? 'selected' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="rule_text" name="rule_text" rows="4" required><?= htmlspecialchars($rule['rule_text']) ?></textarea>
                </div>
